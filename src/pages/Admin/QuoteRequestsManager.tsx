...
import { Eye, Download, Check, Clock, Mail, Phone, User, Calendar, DollarSign, MessageSquare } from 'lucide-react';
...
const QuoteRequestsManager: React.FC = () => {
  ...
  const exportToCSV = () => {
    const headers = ['Date', 'Name', 'Email', 'Phone', 'Project Type', 'Material', 'Size', 'Budget', 'Status'];
